...
export const Sec2 = ({
  ...
  return (
    <UniversalSection className="w-full h-fit items-start justify-start flex flex-col gap-y-10 lg:gap-y-14 xl:gap-y-24">
      ...
      <div className="w-full h-fit items-start justify-start grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 md:gap-5 lg:gap-y-7">
        {items.map((item, index) => (
          ...
          >
            <span className="w-full h-fit items-start justify-start flex flex-col gap-y-3 text-foreground">
              <div className="bg-background flex w-full aspect-video items-center justify-center h-auto p-2 rounded-lg mb-5 border border-muted-foreground/10">
            ...
            {text && (
              <div className="text-sm md:text-sm xl:text-base text-muted-foreground tracking-wider text-pretty">
                {item.text}
              </div>
            )}
          </span>
