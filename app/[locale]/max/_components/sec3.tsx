...
export const Sec3 = ({
  ...
  return (
    <UniversalSection className="w-full h-fit items-start justify-start flex flex-col gap-y-10 lg:gap-y-14 xl:gap-y-24 relative overflow-hidden group">
      ...
      <div className="w-full h-fit items-start justify-start flex gap-7 flex-col lg:flex-row z-10 lg:opacity-0 duration-1000 ease-in-out lg:group-hover:opacity-100">
      ...
      <div className="w-full h-fit items-start justify-start grid grid-cols-1 gap-14 md:gap-10 lg:gap-y-20 z-10 lg:opacity-0 delay-300 duration-1000 ease-in-out lg:group-hover:opacity-100">
